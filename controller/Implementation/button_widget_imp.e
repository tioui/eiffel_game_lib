...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			l_ev_horizontal_box_1.extend (lbl_button_name)
			l_ev_horizontal_box_1.extend (l_ev_cell_2)
			extend (cb_is_pressed)

			l_ev_horizontal_box_1.disable_item_expand (lbl_button_name)
			lbl_button_name.set_minimum_width (20)
			cb_is_pressed.disable_sensitive
			cb_is_pressed.align_text_center
			set_minimum_width (23)
	...
	frozen create_interface_objects
		...
		do
			...
			create l_ev_cell_1
			create lbl_button_name
			create l_ev_cell_2
			create cb_is_pressed
...
feature -- Access
	...
	lbl_button_name: EV_LABEL
	cb_is_pressed: EV_CHECK_BUTTON
