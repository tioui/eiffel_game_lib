...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			l_ev_vertical_box_1.extend (lbl_select)
			l_ev_vertical_box_1.extend (lst_controllers)
			l_ev_vertical_box_1.extend (l_ev_horizontal_box_1)
			l_ev_horizontal_box_1.extend (l_ev_cell_1)
			l_ev_horizontal_box_1.extend (btn_ok)

			l_ev_vertical_box_1.disable_item_expand (lbl_select)
			l_ev_vertical_box_1.disable_item_expand (l_ev_horizontal_box_1)
			lbl_select.set_text ("Select a controller")
			lst_controllers.set_minimum_width (50)
			lst_controllers.set_minimum_height (200)
			l_ev_horizontal_box_1.disable_item_expand (btn_ok)
			btn_ok.set_text ("OK")
			...
			set_all_attributes_using_constants
				...
				-- Connect events.
			btn_ok.select_actions.extend (agent btn_ok_on_key_pressed)
...
feature {NONE} -- Implementation
	...
	btn_ok_on_key_pressed
			-- Called by `select_actions' of `btn_ok'.
		deferred
		end
