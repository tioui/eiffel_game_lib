...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			l_ev_horizontal_box_1.extend (lbl_number)
			l_ev_horizontal_box_1.extend (l_ev_cell_2)
			extend (l_ev_table_1)

			l_ev_horizontal_box_1.disable_item_expand (lbl_number)
			lbl_number.set_minimum_width (20)
			l_ev_table_1.resize (3, 3)
				-- Insert and position all children of `l_ev_table_1'.
			l_ev_table_1.put_at_position (cb_left, 1, 2, 1, 1)
			l_ev_table_1.put_at_position (cb_right, 3, 2, 1, 1)
			l_ev_table_1.put_at_position (cb_bottom, 2, 3, 1, 1)
			l_ev_table_1.put_at_position (cb_top, 2, 1, 1, 1)
			cb_left.disable_sensitive
			cb_right.disable_sensitive
			cb_bottom.disable_sensitive
			cb_top.disable_sensitive
...
feature -- Access
	...
	lbl_number: EV_LABEL
	cb_left, cb_right, cb_bottom, cb_top: EV_CHECK_BUTTON
