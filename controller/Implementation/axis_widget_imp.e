...
feature {NONE}-- Initialization
	...
	frozen initialize
		...
		do
			...
			lbl_name.set_minimum_width (20)
			hr_slide.disable_sensitive
			hr_slide.value_range.adapt (create {INTEGER_INTERVAL}.make (-32768, 32767))
			disable_item_expand (lbl_name)
